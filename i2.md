...
- **Assessment Test (first week):**  
  ...
  - Students register test level **before each test** using this form [Which IC Level do you want to attempt?](https://forms.gle/duVmcmaxzbcmZqr27) and registr test times **once for all the test** using this online form: [Registration for IC Assessment/Level Test](https://forms.gle/enEpBMuf6xjagpVj6)  
