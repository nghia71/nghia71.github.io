...
The volume runs to **54 chapters** in five parts, each chapter opening four themed sections — **217 in all** — with **1,395 problems** across Algebra, Combinatorics, Geometry, and Number Theory: 998 worked examples and 397 exercises, over 672 A4 pages. Every chapter opens with a puzzle. T1 is the **first pass** through the book: the easier problems in each section, worked thoroughly. T2 makes the second pass through the same chapters at a higher difficulty — the book is built to be climbed twice.
...
The multi-part structure of the Medium problems is not there to make the paper longer — it is there to give you somewhere to go. The questions inside one lead toward the result, so a team that cannot see the whole path can still walk the first part of it and show what they know.
...
All assignments and tests are graded with comments by Mr. Nghia. Selected teams present their solutions as part of the club's weekly Sunday session (see [Programs](./programs.md#the-weekly-sunday-session)), or send a recording if both members are away. Results and individual evaluations are published on the site.
